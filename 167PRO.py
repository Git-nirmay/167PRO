...
color_label_name = Label(root,text="Enter a color gradmaaa")
color_label_name.place(relx=0.6,rely=0.9,anchor=CENTER)

input_box= Entry(root)
input_box.insert(0,"black")
input_box.place(relx=0.7,rely=0.9,anchor=CENTER)

canvas= Canvas(root,width=590,height=510,bg="white",highlightbackground="blue")
canvas.pack()
Blood = ImageTk.PhotoImage(Image.open ("R.png")) 
Direction=""
OldX=50
OldY=50
NewY=50
